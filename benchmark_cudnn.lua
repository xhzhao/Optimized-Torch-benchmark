...
local nets = {}
nets[#nets+1] = require 'alexnet_cudnn'
nets[#nets+1] = require 'alexnet_g1_cudnn'
nets[#nets+1] = require 'vgg_e_cudnn'
--nets[#nets+1] = require 'googlenet_cudnn'
--nets[#nets+1] = require 'resnet_cudnn'
