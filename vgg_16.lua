function vgg_16(lib)
   ...
   --return model,'VGG16 Model-' .. modelType, {1,3,224,224}
   --return model,'VGG16 Model-' .. modelType, {2,3,224,224}
   --return model,'VGG16 Model-' .. modelType, {4,3,224,224}
   return model,'VGG16 Model-' .. modelType, {8,3,224,224}
   --return model,'VGG16 Model-' .. modelType, {16,3,224,224}
   --return model,'VGG16 Model-' .. modelType, {32,3,224,224}
   --return model,'VGG16 Model-' .. modelType, {64,3,224,224}
end
